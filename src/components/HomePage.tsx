      ...
      <header className="bg-white shadow-md sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <h1 className="text-[#309898] text-xl sm:text-2xl">Vytara</h1>
          </div>
          <div className="flex items-center gap-2 sm:gap-4">
            <button
              onClick={onNavigateToVault}
              className="px-2 py-2 sm:px-4 text-sm sm:text-base bg-[#FF8000] text-white rounded-lg hover:bg-[#FF8000]/80 transition"
            >
              <span className="hidden sm:inline">Visit </span>Vault
            </button>
            <button
              onClick={onNavigateToProfile}
              className="px-2 py-2 sm:px-4 text-sm sm:text-base bg-[#309898] text-white rounded-lg hover:bg-[#309898]/80 transition"
            >
              Profile
            </button>
          </div>
