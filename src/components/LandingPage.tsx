      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          >
            ...
            <span className="text-[#309898]">Vytara</span>
          </motion.div>
          ...
          <div className="flex items-center gap-4">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={onLogin}
              className="px-6 py-2 text-[#309898] border-2 border-[#309898] rounded-full hover:bg-[#309898] hover:text-white transition-all"
            >
              Log In
            </motion.button>
            <motion.button
              ...
              className="px-6 py-2 bg-gradient-to-r from-[#309898] to-[#FF8000] text-white rounded-full shadow-lg hover:shadow-xl transition-all"
            >
              Get Started
            </motion.button>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute left-1/2 -translate-x-1/2 -bottom-20 w-40 h-40 bg-white rounded-full shadow-2xl border-8 border-white flex items-center justify-center"
            >
